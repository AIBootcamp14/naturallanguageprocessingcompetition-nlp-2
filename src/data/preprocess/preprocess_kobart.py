...
from data.dataset import DatasetForTrain, DatasetForVal
from data.dataset import DatasetForInference
...
def prepare_train_dataset(config, preprocessor, data_path, tokenizer):
    ...
    encoder_input_train , decoder_input_train, decoder_output_train = preprocessor.make_input_t5(train_data)
    encoder_input_val , decoder_input_val, decoder_output_val = preprocessor.make_input_t5(val_data)
